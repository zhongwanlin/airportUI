...
var utility = (function (utility) {
	...
	utility.getCurrentTimeInfo = function (dateInfo) {
		...
		var weekDayEN = ['Monday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
		...
		return {
			...
			"zh-CN": weekDay[day],
			"en-US": weekDayEN[day],
			"ymr": year + "-" + (month < 10 ? '0' + month : month) + "-" + (date < 10 ? '0' + date : date),
			"ymrhsm": year + "-" + (month < 10 ? '0' + month : month) + "-" + (date < 10 ? '0' + date : date) + " " + (hour < 10 ? '0' + hour : hour) + ":" + (min < 10 ? '0' + min : min) + ":" + (second < 10 ? '0' + second : second),
		};
	};
