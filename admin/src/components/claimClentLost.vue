<template>
    <div id="claimLostItem">
        <Modal :value="true" class="noContentPadding" :mask-closable="false" width="70" :styles="{top: '5%'}" title="认领失物" @on-cancel="closeModal">
            <div class="modalTable" :style="{maxHeight: (height-200)+'px',overflowY: 'auto'}">
                <div class="detail">
                    <table>
                        <tr>
                            <td class="label" style="width: 200px;"><span class="request">*</span>旅客姓名</td>
                            <td style="width: 20%;">
                                <template>
                                    <Input v-model="itemInfo.ownerName" placeholder="请输入旅客姓名" style="width: 100%" />
                                </template>
                            </td>
                            <td class="label" style="width: 200px;"><span class="request">*</span>旅客电话</td>
                            <td style="width: 20%;">
                                <template>
                        ...
                        <tr>
                            <td class="label"><span class="request">*</span>邮寄地址</td>
                            <td colspan="3">
                                <template>
                        ...
                        <tr>
                            <td class="label"><span class="request">*</span>旅客证件类型</td>
                            <td>
                                <template>
                            ...
                            <td class="label"><span class="request">*</span>旅客证件号</td>
                            <td>
                                <template>
                        ...
                        <tr>
                            <td class="label"><span class="request">*</span>移交方式</td>
                            <td>
                                <template>
                        ...
                        <tr>
                            ...
                            <td>
                                <template>
                                    <Select v-model="itemInfo.takeUserCertType" placeholder="选择代领人证件类型" style="width: 100%;">
                                        <template v-for="(item, index) in $config.ownerCertType">
                                            <Option :value="item.id" :key="index">{{item.name}}</Option>
                                        </template>
                                    </Select>
                        ...
                        <tr>
                            ...
                            <td>
                                <template>
                                    <Input v-model="itemInfo.takeUserCertNo" placeholder="请输入代领人证件号" style="width: 100%" />
                                </template>
                            </td>
                        ...
                        <tr>
                            <td class="label">委托授权书</td>
                            <td colspan="3">
                                <Row>
                                    <Col span="8"><p style="padding-top: 5px;"><input name="photo" ref="authorizationCertPhoto" id="authorizationCertPhoto" type="file"></p></Col>
                                    <Col span="16">
                        ...
                        <tr>
                            <td class="label">旅客有效身份证件正面</td>
                            <td colspan="3">
                                <Row>
                                    <Col span="8"><p style="padding-top: 5px;"><input name="photo" ref="takeUserCertPhoto1" id="takeUserCertPhoto1" type="file"></p></Col>
                                    <Col span="16">
                                        <p style="padding-top: 3px;">
                                ...
                                <div v-if="!!itemInfo.takeUserCertPhoto1">
                                    <img :src="$config.hostName+'/lostFound/'+(typeof itemInfo.takeUserCertPhoto1.split(',')[1]!='undefined'?itemInfo.takeUserCertPhoto1.split(',')[1]:itemInfo.takeUserCertPhoto1.split(',')[0])"/>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="label">旅客有效身份证件背面</td>
                            <td colspan="3">
                                <Row>
                                    <Col span="8"><p style="padding-top: 5px;"><input name="photo" ref="takeUserCertPhoto2" id="takeUserCertPhoto2" type="file"></p></Col>
                                    <Col span="16">
                                        <p style="padding-top: 3px;">
                                ...
                                <div v-if="!!itemInfo.takeUserCertPhoto2">
                                    <img :src="$config.hostName+'/lostFound/'+(typeof itemInfo.takeUserCertPhoto2.split(',')[1]!='undefined'?itemInfo.takeUserCertPhoto2.split(',')[1]:itemInfo.takeUserCertPhoto2.split(',')[0])"/>
                                </div>
                            </td>
                        </tr>
                    </table>
...
export default {
    ...
    methods: {
        ...
        saveLostItem() {
            var self = this;
            // if(self.itemInfo.areaCode.length=="") {
            //     self.$Message.error("请选择航站楼");
            //     return;
            // }
            // if(self.itemInfo.locationName.length=="") {
            ...
            self.axios({
                ...
                data: self.$qs.stringify({
                    ...
                    lostItemOfficialPic1: !!self.lostItemOfficialPic1?self.itemInfo.lostItemOfficialPic1.split(',')[1]:"", //失物正面外观图片, 传入“附件上传接口”返回的相对url地址
                    lostItemOfficialPic2: !!self.lostItemOfficialPic2?self.itemInfo.lostItemOfficialPic2.split(',')[1]:"", //失物背面外观图片, 传入“附件上传接口”返回的相对url地址
                    lostItemOfficialPic3: !!self.lostItemOfficialPic3?self.itemInfo.lostItemOfficialPic3.split(',')[1]:"", //失物内包装图片, 传入“附件上传接口”返回的相对url地址
                    lostItemOfficialPic4: !!self.lostItemOfficialPic4?self.itemInfo.lostItemOfficialPic4.split(',')[1]:"", //失物其他图片, 传入“附件上传接口”返回的相对url地址
