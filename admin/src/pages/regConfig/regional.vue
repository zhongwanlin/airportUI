                ...
                <table>
                    <tr>
                        <td>
                            &nbsp;&nbsp;区域名称
                            <template>
                                <Input v-model="searchInfo.roleName" clearable placeholder="请输入区域名称" style="width:150px;"/>
                            </template>
                            <template>
                ...
                <div class="modalTable">
                    <div class="detail">
                        <table>
                            <tr>
                                <td>
                                    <span class="request">*</span>区域名称：
                                    <div><Input v-model="itemInfo.roleName" placeholder="填写区域名称" style="width: 100%" /></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    区域描述：
                                    <div><Input v-model="itemInfo.roleDesc" placeholder="填写区域描述" style="width: 100%" /></div>
                                </td>
                            </tr>
                        </table>
                    </div>
